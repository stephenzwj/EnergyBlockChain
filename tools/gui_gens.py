...
class gens_ui(QtWidgets.QVBoxLayout):
    ...
    def setup(self, window):
        ...
        headings = ['Bus ID', 'Pg', 'Qg', 'Qmax', 'Qmin', 'Vg', 'mBase', 'Status', 'Pmax', 'Pmin', 'Pc1', 'Pc2',
                    'Qc1min', 'Q1max', 'Qc2min', 'Qc2max', 'ramp_agc', 'ramp_10', 'ramp_30', 'ramp_q', 'apf']
    ...
    def update_data_matrix(self, tableWidgetItem):
        ...
        if tableWidgetItem.column() == 0:
            ...
            value = gui_utility.validate(tableWidgetItem.text(), lower_bound, upper_bound, l_inclusive=True,
                                         u_inclusive=True, convert_to_integer=True)
        ...
        if value is not False:
            ...
            self.main_window.show_status_message("Gen row " + str(
